...
// Local, physical device on the same WiFi as this machine: 'http://10.213.17.155:5050/api'
...
//   This has now changed twice in a week (10.129.39.155 → 10.75.45.155 →
//   10.213.17.155) purely from reconnecting to WiFi — if this keeps
//   happening, ask about setting a static/reserved IP for this machine on
//   your router instead of hand-editing this file each time.
//   A physical device on the wrong subnet gets no route at all to the
//   server, which surfaces as a bare axios "Network Error" with no
//   response — and nothing reaching the backend log, since the request
...
export const ApiIPAddress = 'http://10.213.17.155:5050/api';
